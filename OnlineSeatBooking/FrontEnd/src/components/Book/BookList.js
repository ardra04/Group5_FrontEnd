...
class BookList extends Component {
  ...
  findAllBooks(currentPage) {
    ...
    axios
      .get(
        "http://localhost:8081/rest/seatbooking?pageNumber=" +
          currentPage +
          "&pageSize=" +
  ...
  searchData = (currentPage) => {
    ...
    axios
      .get(
        "http://localhost:8081/rest/seatbooking/search/" +
          this.state.search +
          "?page=" +
          currentPage +
          "&size=" +
      ...
      <div>
        <div style={{ display: this.state.show ? "block" : "none" }}>
          <MyToast
            ...
            message={"AdminstrationOffice Deleted Successfully."}
            type={"danger"}
          />
        </div>
        <Card className={"border border-dark bg-dark text-white"}>
          <Card.Header>
            <div style={{ float: "left" }}>
              <FontAwesomeIcon icon={faList} /> AdminstrationOffice List
            </div>
          ...
          <Card.Body>
            <Table bordered hover striped variant="dark">
              ...
              <tbody>
                {books.length === 0 ? (
                  <tr align="center">
                    <td colSpan="7">No AdminstrationOffice Available.</td>
                  </tr>
                ) : (
                  books.map((book) => (
                    <tr key={book.id}>
                      ...
                      <td>{book.floor}</td>
                      <td>{book.availablespaces}</td>
                      <td>{book.seatcapacity}</td>
                      <td>
                        <ButtonGroup>
                          <Link
                            to={"edit/" + book.id}
